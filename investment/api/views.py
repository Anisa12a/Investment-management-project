...
#The endpoint to get all trades:
@api_view()
...
#The endpoint to get all cash flows:
@api_view()
...
#The endpoint for gross expected amount:
...
#The endpoint for realized amount::
...
# The endpoint for remaining invested amount:
...
#The API endpoint to get detailed information about a specific trade, including its associated cash flows:
@api_view(['GET'])
...
#The endpoint to calculate the total amount invested in all trades or a specific trade:
@api_view(['GET'])
